...
class SmhiService:
    ...
    async def get_cloud_cover(self, lat: float, lon: float, granularity: Granularity) -> CloudCoverResponse:
        ...
        data_points = _aggregate_values(raw_data.get("value", []), granularity)
    ...
    async def get_lightning(self, lat: float, lon: float, granularity: Granularity) -> LightningResponse:
        ...
        data_points = _aggregate_thunder_as_probability(raw_data.get("value", []), granularity)
    ...
    async def get_combined_weather(self, lat: float, lon: float, granularity: Granularity) -> CombinedWeatherResponse:
        ...
        cloud_data = _aggregate_values(cloud_raw.get("value", []), granularity)
        ...
        try:
            ...
            lightning_data = _aggregate_thunder_as_probability(thunder_raw.get("value", []), granularity)
